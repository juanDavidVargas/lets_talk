...
<link rel="stylesheet" href="{{asset('eventcalendar/css/mobiscroll.javascript.min.css')}}">
<script src="{{asset('eventcalendar/js/mobiscroll.javascript.min.js')}}"></script>
  ...
  <div style="height:100%">
    ...
    <div id="demo-add-popup">
        <div class="mbsc-form-group">
            <label>
                Title
                <input mbsc-input id="event-title" placeholder="Name Event">
            </label>
            <label>
                Description
...
<script>
    ...
    mobiscroll.setOptions({
        ...
        themeVariant: 'light'                                         // More info about themeVariant: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-themeVariant
    });
    ...
    var oldEvent,
        ...
        starts = document.getElementById('start-input'),
        ends = document.getElementById('end-input'),
    ...
    function createAddPopup(elm)
    {
        ...
        popup.setOptions({
            // More info about headerText: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-headerText
            headerText: '',
            // More info about buttons: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-buttons
            buttons: ['cancel', {
                text: 'Add',
                keyCode: 'enter',
                handler: function ()
    ...
    function createEditPopup(args)
    {
        ...
        popup.setOptions({
            headerText: 'Edit Event',                                 // More info about headerText: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-headerText
            buttons: ['cancel', {                                     // More info about buttons: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-buttons
                text: 'Save',
                keyCode: 'enter',
                handler: function ()
                {
    ...
    var popup = mobiscroll.popup('#demo-add-popup',
    {
        ...
        fullScreen: true,
        onClose: function ()
        {                                        // More info about onClose: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#event-onClose
            if (deleteEvent)
            {
        ...
        responsive:
        {                                                 // More info about responsive: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-responsive
            medium: {
                display: 'anchored',                                  // Specify display mode like: display: 'bottom' or omit setting to use default
                width: 400,                                           // More info about width: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-width
                fullScreen: false,
                touchUi: false
            }
        }
    ...
    var range = mobiscroll.datepicker('#event-date',
    {
        ...
        touchUi: true,
        responsive: datePickerResponsive,                             // More info about responsive: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-responsive
    ...
    colorPicker = mobiscroll.popup('#demo-event-color',
    {
        ...
        showArrow: false,
        showOverlay: false,
        buttons: [                                                    // More info about buttons: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-buttons
            'cancel',
            {
                text: 'Set',
                keyCode: 'enter',
        ...
        {                                                 // More info about responsive: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-responsive
            medium: {
                display: 'anchored',                                  // Specify display mode like: display: 'bottom' or omit setting to use default
                anchor: document.getElementById('event-color-cont'),  // More info about anchor: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-anchor
                buttons: {}                                           // More info about buttons: https://docs.mobiscroll.com/5-17-0/javascript/eventcalendar#opt-buttons
            }
        }
    });
