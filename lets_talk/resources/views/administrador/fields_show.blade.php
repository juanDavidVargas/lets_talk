<div class="row m-t-30">
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100 validate-input" data-validate="Required">
            {!! Form::text('nombres', isset($usuario) ? $usuario->nombres : null, ['class' => 'input100', 'id' => 'nombres', 'readonly' => 'readonly']) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100 validate-input" data-validate="Required">
            {!! Form::text('apellidos', isset($usuario) ? $usuario->apellidos : null, ['class' => 'input100', 'id' => 'apellidos', 'readonly' => 'readonly']) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100 validate-input" data-validate="Required">
            {!! Form::text('numero_documento', isset($usuario) ? $usuario->numero_documento : null, ['class' => 'input100', 'id' => 'numero_documento', 'readonly' => 'readonly']) !!}
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100">
            {!! Form::date('fecha_nacimiento', isset($fecha_nacimiento_formato) ? $fecha_nacimiento_formato : null, ['class' => 'input100', 'id' => 'fecha_nacimiento', 'readonly' => 'readonly']) !!}
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100">
            {!! Form::text('telefono', isset($usuario) ? $usuario->telefono : null, ['class' => 'input100', 'id' => 'telefono', 'readonly' => 'readonly']) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100">
            {!! Form::text('celular', isset($usuario) ? $usuario->celular : null, ['class' => 'input100', 'id' => 'celular', 'readonly' => 'readonly']) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100 validate-input" data-validate="Required">
            {!! Form::email('correo', isset($usuario) ? $usuario->correo : null, ['class' => 'input100', 'id' => 'correo', 'readonly' => 'readonly']) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-3">
        <div class="wrap-input100">
            {!! Form::text('direccion_residencia', isset($usuario) ? $usuario->direccion_residencia : null, ['class' => 'input100', 'id' => 'direccion_residencia', 'readonly' => 'readonly']) !!}
